...
```html
<script src="https://cdn.jsdelivr.net/npm/interactive-blocks@1.0.3/dist/interactive-blocks.min.js"></script>
```
...
```html
<script src="https://cdn.jsdelivr.net/npm/interactive-blocks@1.0.3/dist/interactive-blocks.min.js.map"></script>
```
